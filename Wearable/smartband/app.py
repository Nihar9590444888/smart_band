...
# Title and subheader
st.markdown('<p class="title">🏋‍♂ Smart Wrist Band</p>', unsafe_allow_html=True)
st.markdown('<p style="font-size:24px; font-family:Arial; color:pink;">Monitor your health parameters in real-time.</p>', unsafe_allow_html=True)
...
with metric_container1:
    # st.markdown('<p style="font-size:24px; font-family:Arial; color:red;">Vital Signs</p>',unsafe_allow_html=True)
